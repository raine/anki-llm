...
const argv = yargs(hideBin(process.argv))
  .usage('Usage: $0 <input> <deck> <model> [options]')
  .command(
    '$0 <input> <deck> <model>',
  ...
  .example(
    '$0 export.csv "My Deck" "Basic" --key-field noteId',
    'Import using noteId as key',
  )
  .example('$0 data.yaml "Japanese" "Custom" -k Id', 'Import using Id as key')
  .help()
  .parseSync();
